"""V1 시나리오 — 회원 TEST02006 의 A→B→C→A부분반품시도 흐름.
...
MATCHED = TMP / "v1_test02006_matched.csv"
INSPECT = TMP / "_v1_test02006_inspect.txt"

KEYS = ["TEST02006", "SAL02V002", "SAL02V003", "SAL02V004"]
